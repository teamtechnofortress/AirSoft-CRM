...
import Productvariations from "/sub-components/productvariations/variations.js";
...
const Home = ({params}) => {
    ...
    // const handelproductvariation = async (id) =>{
    //     console.log(id);
    //     try {
    ...
    const fetchAllProductsvariations = async (id) => {
        ...
        try {
            ...
            if (response.data && response.data.data.length > 0) {
                setProducts(response.data.data); // ✅ Update state after each page
                // await delay(500);
                setLoading(false);
            } else {
                console.error("Unexpected API Response:", response.data);
                                ...
                                <Card.Body className="p-0">
                                    <Tab.Content>
                                        <Tab.Pane eventKey="all" className="pb-4 p-4">
                                            <Productvariations products={products} status={'all'} />
                                            {/* Active Projects  */}
                                            {/* <ActiveProjects /> */}
                                        </Tab.Pane>
