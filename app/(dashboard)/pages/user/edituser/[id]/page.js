...
const EditUser = ({params}) => {
  ...
  const handleSubmit = async (event) => {  
    ...
    try {
        const response = await axios.post(`${process.env.NEXT_PUBLIC_HOST}/oldapi/user/edituser`, formData);
          ...
          <Col xl={12} lg={12} md={12} xs={12}>
            <Card>
              ...
              <Card.Body>
                ...
                <div>
                  <div className="mb-6">
                    <h4 className="mb-1">Update information</h4>
                  </div>
                  {hasMounted && 
                  <Form method="POST" onSubmit={handleSubmit}>
                    <Row className="mb-3">
                      ...
                      <Col sm={4} className="mb-3 mb-lg-0">
                        <Form.Control type="hidden" value={formData.id} onChange={handleChange} name="id"  id="id" />
                    ...
                    <Row className="mb-3">
                      ...
                      <Col md={8} xs={12}>
                        <Form.Control type="text" value={formData.password} onChange={handleChange} name="password" placeholder="Enter Password" id="password" />
                      </Col>
                    </Row>
                    {/* row */}
                    <Row className="mb-3">
