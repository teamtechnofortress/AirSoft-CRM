            ...
            <div>
              ...
              <Form>
                ...
                <Row className="mb-3">
                  ...
                  <Col md={8} xs={12}>
                    <Form.Control type="text" placeholder="Enter Password" id="password" required />
                  </Col>
                </Row>
                {/* row */}
                <Row className="mb-3">
                ...
                <Row className="align-items-center">
                  <Form.Label className="col-sm-4" htmlFor="zipcode">Role</Form.Label>

                  <Col md={8} xs={12}>
                    <Form.Control type="text" placeholder="Enter Role code" id="zipcode" required />
                  </Col>
