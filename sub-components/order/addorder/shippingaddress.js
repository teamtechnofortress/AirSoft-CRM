...
const ShippingAddress = ({shippingData,handleChange,countries}) => {
  return (
    <>
        ...
        <Row className="mb-3">
            <Form.Label className="col-sm-4 col-form-label form-label" htmlFor="contactinfo">Company</Form.Label>
            {/* <Col sm={4} className="mb-3 mb-lg-0">
        ...
        <Row className="mb-3">
            <Form.Label className="col-sm-4 col-form-label form-label" htmlFor="contactinfo">Phone</Form.Label>
            <Col sm={4} className="mb-3 mb-lg-0">
              <Form.Control type="text" value={shippingData.shippingphone} onChange={handleChange} name="shippingphone" placeholder="Enter phone" id="contactinfo" required />
            </Col>
            {/* <Col sm={4} className="mb-3 mb-lg-0">
        ...
        <Row className="mb-3">
            <Form.Label className="col-sm-4" htmlFor="country">Customer provided note</Form.Label>
            <Col md={8} xs={12}>
              <Form.Control
                  as="textarea"
                  rows={3}
